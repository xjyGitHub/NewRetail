    ...
    <div class="page-header" style="border: 0px;">
                ...
                <div class="tab-pane fade in active" id="home">
                    <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12 ">
                        <div class="form-group">
                            <label class="col-lg-2 col-md-3 col-sm-3 control-label no-padding-right" for="form-field-1">
                                商品名称</label>
                    ...
                    <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12 ">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-9">
                                <div id="preview1">
                                    <img id="imghead1" border="0" src="assets/css/images/photo_icon.png"
                                         class="img-responsive" alt="Cinque Terre" width="90" height="90"
                                         onclick="$('#preview1Img').click();">
                                </div>
                                <input type="file" onchange="preview1Image(this)" style="display: none;"
                                       id="preview1Img">
                            </div>
                        </div>
                    </div>
        ...
        <div class="searchForm" style="padding: 4px 0;" id="searchForm">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 ">
                <div class="form-group">
                    <label class="col-lg-4 col-md-4 col-sm-4 control-label no-padding-right" for="form-field-1">
                        商品名称</label>
                    <div class="col-lg-8 col-md-8 col-sm-8">
											<span class="block input-icon input-icon-right">
												<input type="text" id="searchGoodsName" name="ebcuNameCn"
                                                       class="form-control">
											</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <select class="form-control" id="searchSelect">
                            ...
                            <option name="cat" value="1">销量</option>
                            <option name="cat" value="2">最新</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/assets/js/date-time/bootstrap-datetimepicker.min.js"></script>
<script src="${pageContext.request.contextPath}/assets/js/date-time/bootstrap-datetimepicker.zh-CN.js"></script>
