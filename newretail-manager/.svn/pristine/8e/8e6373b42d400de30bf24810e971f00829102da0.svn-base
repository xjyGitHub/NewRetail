...
function preview3Image(file)
        {
          ...
          if (file.files && file.files[0])
          {
              div.innerHTML ='<img id=imghead3 onclick=$("#preview3Img").click()>';
...
function preview4Image(file)
        {
          ...
          if (file.files && file.files[0])
          {
              div.innerHTML ='<img id=imghead4 onclick=$("#preview4Img").click()>';
...
function preview5Image(file)
        {
          ...
          if (file.files && file.files[0])
          {
              div.innerHTML ='<img id=imghead5 onclick=$("#preview5Img").click()>';
