...
public class UserSellerTable {
    ...
    private Double piecewiseAgentFee;
    ...
    public void setManagementClass(String managementClass) {
        this.managementClass = managementClass == null ? null : managementClass.trim();
    }
    ...
    public Date getOrderLeadTime() {
        return orderLeadTime;
    }

    public void setOrderLeadTime(Date orderLeadTime) {
    ...
    public Double getPiecewiseAgentFee() {
        return piecewiseAgentFee;
    }

    public void setPiecewiseAgentFee(Double piecewiseAgentFee) {
